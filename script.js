...
// Edit info box text and variables (such as proximity) to match those in your GeoJSON data
info.update = function (proximity) {
  this._div.innerHTML = '<h4>Connecticut Town<br />Proximity</h4>' +  (proximity ?
    '<b>' + proximity.town + '</b><br />' + proximity.density2010 + ' people / mi<sup>2</sup>'
    : 'Hover over a town');
};
info.addTo(map);
